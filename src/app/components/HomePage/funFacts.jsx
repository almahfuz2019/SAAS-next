...
const FunFacts = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between py-12 px-4 bg-white max-w-screen-xl gap-10 mx-auto">
      <div className="flex items-center space-x-8">
        {/* Stat Card 1 */}
        <div
          className="bg-primary w-52 text-white rounded-2xl px-6 py-8  relative"
          style={{
      ...
      <div className="mt-8 md:mt-0 md:ml-8 ">
        <h3 className="text-[40px] leading-[50px] font-semibold text-accent">
          Best choice for property management and services
        </h3>
        <p className="mt-4 text-xl text-[#676767]">
