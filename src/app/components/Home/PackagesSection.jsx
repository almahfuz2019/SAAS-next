...
const PackagesSection = () => {
  return (
    <div className="relative mt-20 lg:mt-0">
      <div className="bg-[#F5F8FF] lg:h-96 lg:-mb-96"></div>
      <div className="lg:pt-24  lg:pb-6 pb-20  bg-primary sm:bg-transparent">
        <div className="container mx-auto max-w-screen-xl">
          ...
          <div>
            ...
            <div className="relative text-white mb-16 lg:mx-4 bg-primary lg:rounded-3xl px-4 lg:px-20 pt-16 pb-40 md:pb-60">
              ...
              >
                Choose your <span className="text-[#FFB400]">Package</span>{" "}
                Which <br className="md:block hidden" /> is perfect for your
                Condo
              </h2>
              <p
                data-aos="fade-up"
              ...
              >
                ...
                <br className="hidden lg:block" /> Condo Cloud has affordable
